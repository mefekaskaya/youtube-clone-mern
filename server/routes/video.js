...
router.post("/thumbnail", (req, res) => {
    ...
    ffmpeg(req.body.filePath)
        ...
        .screenshots({
            count:3,//take 3 screenshots with equal intervals
            folder:'uploads/thumbnails',
            size:'320x240',
            //%b comes from ffmpeg and means input basename(filename without extension)
...
router.post("/uploadVideo", (req, res) => {
    ...
    video.save((err,video)=>{
        if(err) return err.status(400).json({ success:false,err });
